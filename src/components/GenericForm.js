...
function GenericForm({ brand, setBrand, category, setCategory, allCate, allBrand }) {
    const pnameId = useId();
    const brandId = useId();
                                ...
                                >
                                    {
                                        ...
                                        allBrand.map((brand, i) => <MenuItem key={i} value={brand}>{brand}</MenuItem>)
                                    }
                                </Select>
